...
class Player {
  constructor(spriteCtx) {
    ...
    this.phunkSprite = new Image();
    this.phunkSprite.src = "./assets/images/player/phunksSprite.png";
  ...
  clear() {
    this.ctx.clearRect(this.pos.x, this.pos.y, 120, 120);
  }
  ...
  drawImage(sourceX, sourceY) {
    this.ctx.drawImage(
      this.phunkSprite,
      1176, // sourceX, x coordinates of Phunk
      2210, // sourceY, y coordinates of Phunk
      24, // Phunk pixel width
      24, // Phunk pixel height
      this.pos.x+6, // Player x position on canvas
      this.pos.y, // Player y position on canvas
      36, // destination height
      36 // destination width
    )
